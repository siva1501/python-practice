...
class Student:
    crs="PYTHON" ## here crs in class level Data member
#main program
s1=Student()
s2=Student()
...
print("\t Student Course:{}".format(s1.crs))##accessing class level data member write obaject
...
print("\t Student Course:{}".format(s2.crs))##accessing class level data member write Object
